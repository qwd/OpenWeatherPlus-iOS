...
@end
@interface HistoricalWeatherDaily :HeWeatherBaseModel
...
@interface HistoricalWeatherHourly :HeWeatherBaseModel
...
@interface HistoricalAirHourly :HeWeatherBaseModel
