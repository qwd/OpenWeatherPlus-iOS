...
@implementation QWeatherHourlyImageView
...
-(void)scrollImage{
    [[QWeatherNotificationCenter rac_addObserverForName:KNotificationScrollImages object:nil] subscribeNext:^(NSNotification * _Nullable x) {
...
-(void)configUI{
    //修改背景渐变颜色
//     self.backLayer.colors = @[(__bridge id)kRandomColor.CGColor,(__bridge id)QWeatherColor_ECECEC.CGColor];
    [self.layer addSublayer:self.backLayer];
    
    self.vlineLayer = [CAShapeLayer qmui_separatorDashLayerWithLineLength:2 lineSpacing:2 lineWidth:1 lineColor:QWeatherColor_A4A4A4.CGColor isHorizontal:NO];
