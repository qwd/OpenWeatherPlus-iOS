...
@implementation QWeatherRefreshHeader
#pragma mark - 重写父类的方法
//- (void)prepare{
//    [super prepare];
//
...
//    self.lastUpdatedTimeLabel.textColor = QWeatherColor_FFFFFF;
//    self.stateLabel.textColor = QWeatherColor_FFFFFF;
