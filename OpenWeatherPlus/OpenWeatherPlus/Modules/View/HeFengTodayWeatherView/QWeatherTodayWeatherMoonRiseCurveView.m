//
//  QWeatherTodayWeatherMoonRiseCurveView.m
//  OpenWeatherPlus
//
...
@implementation QWeatherTodayWeatherMoonRiseCurveView
...
-(void)setStartTime:(NSString *)startTime endTime:(NSString *)endTime tz:(NSString *)tz{
    ...
    NSDate *riseDete = [NSDate dateWithString:startTime formatString:QWeatherFormatString1 timeZone:[NSTimeZone timeZoneWithName:@"UTC"]];
    NSDate *setDete = [NSDate dateWithString:endTime formatString:QWeatherFormatString1 timeZone:[NSTimeZone timeZoneWithName:@"UTC"]];
...
-(void)configUI{
    ...
    self.bottomLine.backgroundColor = QWeatherColor_ECECEC;
...
-(void)drawRect:(CGRect)rect{
    ...
    [QWeatherColor_A4A4A4 setStroke];
    [path stroke];
}
