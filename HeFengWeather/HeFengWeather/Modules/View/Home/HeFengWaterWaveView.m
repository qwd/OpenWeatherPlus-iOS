...
@interface HeFengWaveProxy: NSObject
@property (weak, nonatomic) id executor;
@end

@implementation HeFengWaveProxy
-(void)callback{
...
@implementation HeFengWaterWaveView
...
- (void)initData{
    ...
    self.wavecolor = HeFengColor_F7F8FA;
...
- (CADisplayLink *)timer{
    if (!_timer) {
        HeFengWaveProxy *proxy = [HeFengWaveProxy new];
        proxy.executor = self;
